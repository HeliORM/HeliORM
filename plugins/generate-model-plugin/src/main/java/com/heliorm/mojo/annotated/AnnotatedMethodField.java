 ...
 * @author gideon
 */
public class AnnotatedMethodField implements Field {

    private final Table table;
    private final java.lang.reflect.Method pojoField;

    public AnnotatedMethodField(Table table, java.lang.reflect.Method pojoField) {
        this.table = table;
    ...
    public Class getJavaType() {
        return pojoField.getReturnType();
    }

    @Override
    public FieldType getFieldType() {
        Class<?> type = pojoField.getReturnType();
        if (type.isPrimitive()) {
    ...
    public FieldOrder asc() {
        return () -> AnnotatedMethodField.this;
    }
