...
public final class TableBuilder<T extends Table<O>, O> {
    ...
    public static <T extends Table<O>, O> TableBuilder<T,O> create(Class<O> pojoType) {
            return new TableBuilder<T,O>();
    }

    public FieldBuilder< ByteFieldPart<T,O>> byteField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.BYTE, Byte.class, javaName);
    }

    public FieldBuilder<ShortFieldPart<T,O>> shortField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.SHORT, Short.class, javaName);
    }

    public FieldBuilder<IntegerFieldPart<T,O>> integerField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.INTEGER, Integer.class, javaName);
    }

    public FieldBuilder<LongFieldPart<T,O>> longField(String javaName) {
            return new FieldBuilder<>(Field.FieldType.LONG, Long.class, javaName);
    }

    public FieldBuilder<FloatFieldPart<T,O>> floatField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.FLOAT, Float.class, javaName);
    }

    public FieldBuilder<DoubleFieldPart<T,O>> doubleField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.DOUBLE, Double.class, javaName);
    }

    public FieldBuilder<DateFieldPart<T,O>> dateField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.DATE, Date.class, javaName);
    }

    public FieldBuilder<DurationFieldPart<T,O>> durationField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.DURATION, Duration.class, javaName);
    }

    public FieldBuilder<TimestampFieldPart<T,O>> timestampField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.TIMESTAMP, Instant.class, javaName);
    }

    public FieldBuilder<StringFieldPart<T,O>> stringField(String javaName) {
        return new FieldBuilder<>(Field.FieldType.STRING, String.class, javaName);
    }

    public <E extends Enum> FieldBuilder<EnumFieldPart<T,O,E>> enumField(String javaName, Class<E> enumType ) {
        return new FieldBuilder<>(Field.FieldType.ENUM,  enumType, javaName);
    }
