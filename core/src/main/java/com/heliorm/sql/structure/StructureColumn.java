...
public class StructureColumn implements Column {
    ...
    public JDBCType getJdbcType() {
        switch (field.getFieldType()) {
            ...
            case ENUM: return JDBCType.OTHER;
            case DATE: return JDBCType.DATE;
            case INSTANT: return JDBCType.TIMESTAMP;
            case BOOLEAN: return JDBCType.BOOLEAN;
            case STRING:
            case DURATION:
                return JDBCType.VARCHAR;
            default: throw new UncaughtOrmException(format("Unsupported field type '%s'. BUG!", field.getFieldType()));
        }
    }
